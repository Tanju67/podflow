...
function PodcastersItem({ id, img, name, role }) {
  return (
    <Link
      to={`/podcasters/${id}`}
      className="group font-secondary z-50 flex w-full cursor-pointer flex-col overflow-hidden rounded-4xl border-4 border-transparent bg-white text-black transition-all duration-200 hover:border-4 hover:border-amber-500 hover:shadow-md hover:shadow-amber-500 md:w-[46%] lg:w-[22%]"
    >
      <div>
        <img
